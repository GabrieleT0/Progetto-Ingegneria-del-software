...
public class AdminBean implements  Serializable{
	...
	private static final long serialVersionUID = 8298486480869385613L;
			...
			public AdminBean(String email, String nome, String cognome, String password, String registrazione) {
				this.nome= nome;
			...
			public AdminBean(String email, String nome, String cognome, String password) {
				this.nome= nome;
				this.cognome= cognome;
				this.email= email;
				this.password= password;
			...
			public boolean equals(Object o) {
				if(!o.getClass().equals(this.getClass()))
					return false;
				return this.email.equalsIgnoreCase(((AdminBean)o).email);
			}
