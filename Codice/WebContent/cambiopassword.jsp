	...
	<% if(login == true){ %>
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="password" class="form-control" id="old" name="vecchia" placeholder="" value="" required>
            
            <label for="new">Nuova password</label>
            <input type="password" class="form-control" id="new" name="nuova" placeholder="" value="" required>
            
            <label for="confirm">Conferma password</label>
            <input type="password" class="form-control" id="confirm" name="conferma" placeholder="" value="" required>
            
            <input type="hidden" class="form-control" id="email" name="email" placeholder="" value="<%=email %>" required>
            <input type="hidden" class="form-control" id="action" name="action" placeholder="" value="password" required>
